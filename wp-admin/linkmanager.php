...
switch ($action) {
  case 'Add':
  {
    ...
    if (($auto_toggle == 'Y') && ($link_visible == 'Y')) {
      ...
      $sql_result = mysqli_query( $wpdb->dbh,$sql) or die("Couldn't execute query."."sql=[$sql]". mysqli_error());
    }
  ...
  case 'Delete':
  {
    ...
    $sql_result = mysqli_query( $wpdb->dbh,$sql) or die("Couldn't execute query.".mysqli_error());
  ...
  case 'linkedit':
  {
    ...
    $result = mysqli_query( $wpdb->dbh,$sql) or die("Couldn't execute query.".mysqli_error());
